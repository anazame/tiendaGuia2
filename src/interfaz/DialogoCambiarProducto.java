...
public class DialogoCambiarProducto extends JDialog implements ActionListener {
     ...
     *
     * @param pPrincipal      Ventana principal de la aplicaci�n. pPrincipal !=
     *                        null.
                ...
                try {
                    ...
                    if (cantidadBodega < 0 || cantidadMinima < 0 || valorUnitario < 0) {
                        JOptionPane.showMessageDialog(this,
                                "La cantidad en bodega, cantidad m�nima y valor unitario no pueden ser valores negativos.",
                                "Cambiar producto", JOptionPane.ERROR_MESSAGE);
                    } else {
                        String tipo = tipoStr.toLowerCase();

                        principal.cambiarProducto(txtNombreActual.getText(), nombreNuevo, tipo, valorUnitario,
                                cantidadBodega, cantidadMinima, imagenStr);
                        dispose();
                    }

                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(this,
                            "El valor unitario, cantidad en bodega, cantidad m�nima deben ser valores num�ricos.",
                            "Cambiar producto", JOptionPane.ERROR_MESSAGE);
                }
            }
